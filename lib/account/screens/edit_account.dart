...
class _EditAccountState extends State<EditAccount> {
  ...
  void uploadAvatar(Store store) async {
    try {
      await fileService.upload(
          params, file, accountApi.getAvatarLink, accountApi.finishUploadReq);
      AccountService(store: store).loadAcount();
    } catch (e) {}
  }
  ...
  void saveAccount(Store store) async {
    try {
      ...
      AccountService(store: store).updateAccount(payload);
    } catch (e) {
                      ...
                      onTap: () async {
                        ...
                        if (pickedDate != null) {
                          String formattedDate =
                              DateFormat('dd/MM/yyyy').format(pickedDate);
                          setState(() {
                            accountController['cooperationStartDate']?.text =
                                formattedDate;
                          });
                        } else {}
                      },
